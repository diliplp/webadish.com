        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
              {[
                { name: "Verofax", desc: "verofax.com — incident response, recovery, and ongoing WordPress protection.", href: "/case-studies/verofax" },
                { name: "Shivam Autozone", desc: "shivamautozone.com — security hardening, rebuild, and ongoing support.", href: "/case-studies/shivamautozone" },
                { name: "Crystal Group", desc: "crystalgroup.in — enterprise trust positioning, SEO readiness, and WordPress support.", href: "/case-studies/crystalgroup" },
              ].map((c) => (
