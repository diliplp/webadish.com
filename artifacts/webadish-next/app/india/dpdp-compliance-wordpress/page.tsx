...
import { ArrowRight, CheckCircle2, Database, FileCheck2, LockKeyhole, Shield } from 'lucide-react';
import SiteLayout from '@/components/SiteLayout';

export const metadata: Metadata = {
  title: 'DPDP Compliance Implementation for WordPress',
  description:
    'India-focused DPDP website readiness reviews for WordPress businesses covering consent flows, plugins, access control, and data handling.',
};
...
const outlineDarkClass =
  'inline-flex items-center justify-center gap-2 rounded-xl px-8 py-4 text-base font-medium border border-white/20 text-white hover:bg-white/10 transition-all duration-300';

export default function IndiaDpdpPage() {
  return (
    <SiteLayout>
      <section className="pt-36 pb-20 hero-gradient">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
            Most Indian SMEs have consent, form, and data gaps they don&apos;t know about. We find and fix the technical
            side — alongside your legal advisor.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className={primaryLinkClass}>
              Get a Free Site Assessment <ArrowRight size={18} className="ml-1" />
            </Link>
            <Link href="#what-we-fix" className="inline-flex items-center justify-center gap-2 rounded-xl px-8 py-4 text-base font-medium border-2 border-primary text-primary bg-transparent hover:bg-primary hover:text-primary-foreground transition-all duration-300">
              See what we fix →
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-muted-foreground text-lg">
              Most small and medium businesses do not need a massive consulting project first. They need someone to
              review the actual website stack, the forms, the plugins, the data flow, and the security gaps that make
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <p className="text-muted-foreground mb-8">
              The goal is not to produce theory. It is to give your team a workable implementation plan across
              WordPress, forms, admin access, plugin behavior, and data handling.
            </p>
          ...
          <div className="rounded-3xl bg-white border border-border/50 p-8 shadow-sm">
            ...
            <div className="rounded-2xl bg-gray-50 border border-border/50 p-5">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Ask for a DPDP website readiness review if you want clarity on where your website, forms, plugins, and
                workflows need implementation work first.
              </p>
              <Link href="/contact" className={`${primaryLinkClass} w-full`}>
      ...
      <section className="py-20 bg-gray-950 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className={primaryLinkClass}>
              Request DPDP Review <ArrowRight size={18} className="ml-1" />
            </Link>
            <Link href="/security" className={outlineDarkClass}>
