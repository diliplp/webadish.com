...
export const metadata: Metadata = {
  title: 'India Services | WordPress Protection Pricing',
  description:
    'India-focused WordPress protection pricing, DPDP implementation support, and CERT-In incident-readiness services.',
};
      ...
      <section className="pt-36 pb-20 hero-gradient">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            WordPress Protection Pricing for <span className="text-accent">Indian Businesses</span>
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-10">
            Local-market pricing for dealerships, education brands, eCommerce businesses, and service companies that
            need dependable WordPress protection without mixing INR rates into the global pricing page.
          </p>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div className="max-w-2xl">
                ...
                <p className="text-sm md:text-base text-muted-foreground">
                  We now offer India-focused DPDP implementation support for WordPress websites, lead forms, consent
