...
export const metadata: Metadata = {
  ...
  description: 'How WebAdish rebuilt and hardened shivamautozone.com for trust, speed, and better lead quality.',
};

export default function CaseStudyShivamAutozonePage() {
  return (
    <SiteLayout>
