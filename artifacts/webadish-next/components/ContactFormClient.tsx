...
import { Ambulance, ArrowRight, CheckCircle2, Clock, Mail, MapPin, Phone } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Request Your <span className="text-accent">Free Security Audit</span>
            </h1>
            <p className="text-xl text-muted-foreground">
              Tell us a little about your site and we will review the obvious risks, likely weak points, and the best next step for protection or recovery.
            </p>
            <div className="mt-6 rounded-2xl border border-accent/20 bg-white/90 p-5 shadow-sm">
              ...
              <p className="text-sm text-foreground">
                A human review, not an automated scan. We will assess visible risk, backup posture, plugin exposure, and whether you need a plan, hardening sprint, or emergency response.
              </p>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              {submitted ? (
                <div className="bg-green-50 border border-green-200 rounded-2xl p-10 text-center">
                  ...
                  <button onClick={() => setSubmitted(false)} className="mt-6 text-accent hover:underline text-sm font-medium">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea
                      required
                      rows={5}
                      placeholder="Website URL, what the site does, what concerns you most, and whether this is urgent..."
                      value={form.message}
                      onFocus={trackFormStart}
                  ...
                  <Button type="submit" variant="accent" size="lg" className="w-full text-base" disabled={loading}>
              ...
              <div className="bg-gray-50 rounded-2xl p-8 border border-border/50">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <Link key={item.label} href={item.href} className={`block text-sm font-medium hover:underline ${item.color}`}>
                      {item.label}
                    </Link>
                  ))}
                </div>
